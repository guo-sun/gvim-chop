...
pub mod chop {
    ...
    impl GvimWindow {
        fn new() -> GvimWindow {
            ...
            GvimWindow {
                hwnd: hwnd,
                last_style: get_style(hwnd, GWL_STYLE),
                last_ex_style: get_style(hwnd, GWL_EXSTYLE),
                last_rect: 
    ...
    // TODO make this static somehow so when dll gets initialized
    // i always have this struct
    // method calls would go through this object
    // static x : GvimWindow = GvimWindow::new();
}
